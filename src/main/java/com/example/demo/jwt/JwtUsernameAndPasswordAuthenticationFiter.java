...
//        return super.attemptAuthentication(request, response);  // Buna gerek kalmadı
    }
...
//                .signWith(Keys.hmacShaKeyFor(key.getBytes())) // jwt classları öncesi
                .signWith(secretKey)
                .compact();

        response.addHeader(jwtConfig.getAuthorizationHeader(),jwtConfig.getTokenPrefix() + token);
//        response.addHeader("Authorization", "Bearer " + token); // jwt classları öncesi
